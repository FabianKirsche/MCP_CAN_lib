...
/*********************************************************************************************************
** Function name:           mcp_cmd
** Descriptions:            Sends a command to the mcp via SPI
*********************************************************************************************************/
...
*********************************************************************************************************/
INT8U MCP_CAN::mcp2515_readRegister(const INT8U address) // Tested!
{
    spi_transaction_t t;
    memset(&t, 0, sizeof(t));       //Zero out the transaction
...
*********************************************************************************************************/
void MCP_CAN::mcp2515_setRegister(const INT8U address, const INT8U value) // Tested!
{
    spi_transaction_t t;
    memset(&t, 0, sizeof(t));       //Zero out the transaction
    t.length = 8;                     //Command is 8 bits
...
*********************************************************************************************************/
void MCP_CAN::mcp2515_modifyRegister(const INT8U address, const INT8U mask, const INT8U data) // Tested!
{
...
INT8U MCP_CAN::mcp2515_configRate(const INT8U canSpeed, const INT8U canClock)            
{
    ...
    if (set) {
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: reading registers before setting them");
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF1 = %d", mcp2515_readRegister(MCP_CNF1));
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF2 = %d", mcp2515_readRegister(MCP_CNF2));
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF3 = %d", mcp2515_readRegister(MCP_CNF3));
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: setting registers");
        mcp2515_setRegister(MCP_CNF1, cfg1);
        mcp2515_setRegister(MCP_CNF2, cfg2);
        mcp2515_setRegister(MCP_CNF3, cfg3);
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: reading registers after setting them");
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF1 = %d", mcp2515_readRegister(MCP_CNF1));
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF2 = %d", mcp2515_readRegister(MCP_CNF2));
        //ESP_LOGI(CLASS_TAG, "mcp2515_configRate: MCP_CNF3 = %d", mcp2515_readRegister(MCP_CNF3));
        return MCP2515_OK;
...
INT8U MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
...
#if DEBUG_MODE
    ESP_LOGI(CLASS_TAG, "Starting to Set Mask!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0){
#if DEBUG_MODE
    ...
    if(res > 0){
#if DEBUG_MODE
	ESP_LOGE(CLASS_TAG, "Entering Previous Mode Failure...\r\nSetting Mask Failure...\r\n"); 
#endif
	return res;
    }
#if DEBUG_MODE
    ESP_LOGI(CLASS_TAG, "Setting Mask Successful!\r\n");
#endif
    return res;
}
...
INT8U MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
    ESP_LOGI(CLASS_TAG, "Starting to Set Filter!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0)
    {
#if DEBUG_MODE
      ESP_LOGE(CLASS_TAG, "Enter Configuration Mode Failure...\r\n"); 
#endif
      return res;
    }
...
#if DEBUG_MODE
    ESP_LOGI(CLASS_TAG, "Setting Filter Successfull!\r\n");
#endif
